...
class SirepoDetector(Device):
    ...
    def __init__(self, name='sirepo_det', reg=None, sim_id=None, watch_name=None,
        ...
        #self.par1 = None
        #self.field2 = None
        #self.field2_units = None
        #self.par2 = None
        #self.field3 = None
        #self.field3_units = None
        #self.par3 = None
        #self.field4 = None
        #self.field4_units = None
        #self.par4 = None
        #self.field5 = None
        #self.field5_units = None
        #self.par5 = None
        #self.field6 = None
        #self.field6_units = None
        #self.par6 = None
        #self.field7 = None
        #self.field7_units = None
        #self.par7 = None
        #self.field8 = None
        #self.field8_units = None
        #self.par8 = None
        #self.field9 = None
        #self.field9_units = None
        #self.par9 = None
